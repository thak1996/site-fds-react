...
import { contactServerSchema } from '@/src/infra/mail/server-schemas';
import { NodemailerMailGateway } from '@/src/infra/mail/NodemailerMailGateway';
import { SendContactEmails } from '@/src/core/use-cases/SendContactEmails';
...
export async function POST(request: Request) {
  ...
  try {
    const useCase = new SendContactEmails(new NodemailerMailGateway());
